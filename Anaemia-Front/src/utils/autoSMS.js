...
export async function handleAutoSMS(notification) {
  try {
    ...
    switch (data.type) {
      case 'registration':
        message = `Hello ${name}, your registration with Anaemia is successful. Your ID: ${
          beneficiary.short_id || 'N/A'
        }. Thank you for joining our health program.`;
        break;
      case 'beneficiary_updated':
        message = `Hello ${name}, your profile has been updated in Anaemia. Please contact us if you have any questions.`;
        break;
      case 'follow_up':
      ...
      case 'intervention':
        ...
        break;
      default:
        message = `Hello ${name}, this is an update from Anaemia health program.`;
    }
